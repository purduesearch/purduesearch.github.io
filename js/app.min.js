!function(n,t,e){
    ...
    var o={init:function(e){
        o.select2(),o.stellar(),o.carousel(),o.portfolio(),o.lightCase(),o.sideNav(),
        o.counter(),o.skills(),o.aos(),o.navbarChange()},
        select2:function(){
            n(e).ready(function(){
                n("select").select2()})}
                ,navbarChange:function(){
                    ...
                    n(t).scroll(function(){
                        var e=n(t).scrollTop();return 150<e?(n("#header-navbar"),n("body").addClass("not-on-top")):(n("body").removeClass("not-on-top"),n("#header-navbar").addClass("navbar-transparent")),!1})
                    }
                ,stellar:function(){
                    var e=n(t).width();
                    ...
                    ,carousel:function(){
                        n(".testi-carousel").owlCarousel({
                            ...
                            ,n(".client-slider").owlCarousel({
                                loop:!0,margin:10,nav:!0,navSpeed:1e3,dots:!1,
                                autoplay:!0,autoplaySpeed:1e3,
                                ...
                                ,portfolio:function(){
                                    var t=n(".grid-portfolio").isotope({
                                        itemSelector:".grid-item",masonry:{
                                            ...
                                            ,percentPosition:!0});return n(".filter-button-group").on("click","a",
                                            function(){
                                                ...
                                                n(this).addClass("active")}
                                                    ...
                                                    n("#side-nav-open").click(function(){
                                                        n("#side-nav").css("width","300"),setTimeout(function(){
                                                            ...
                                                            },400)}),n("#side-search-open").click(function(){
