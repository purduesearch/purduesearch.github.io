...
eventsRouter.post("/", async (req, res) => {
    try {
        ...
        const { title, description, type, startTime, endTime, location, isVirtual, projectId, priorityTaskIds, organizerId, attendeeIds, notes, isRecurring, recurrencePattern, recurrenceEndDate, } = req.body;
        if (!title || !startTime) {
