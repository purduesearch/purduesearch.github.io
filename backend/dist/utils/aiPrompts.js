...
export function driveToTasksPrompt(projectName, projectDescription, existingTaskTitles, today, suggestedTaskCount) {
...
export function meetingNotesToTasksPrompt(projectName, attendees, today, suggestedTaskCount) {
    const countHint = suggestedTaskCount
...
export function imageToTaskPrompt(projectName, userNote) {
...
export function duplicateDetectionPrompt(newTitle, newDescription, existingTasks) {
...
export function enrichTaskPrompt(title, description, projectType) {
...
export function deadlineSuggestionPrompt(title, description, storyPoints, teamVelocityPointsPerWeek, projectDeadline, today) {
...
// ── Risk analysis ─────────────────────────────────────────────
export function riskAnalysisPrompt(project, tasks, today) {
...
// ── Sprint planning ───────────────────────────────────────────
export function sprintPlanPrompt(tasks, teamCapacityPoints, sprintLengthDays, today) {
...
export function projectBriefPrompt(project, tasks, milestones, recentUpdates) {
...
// ── Standup synthesis ─────────────────────────────────────────
export function standupSynthesisPrompt(standups, projectName) {
...
export function standupSentimentPrompt(standups) {
...
export function inferDependenciesPrompt(tasks) {
...
export function capacityAnalysisPrompt(members, sprintDays) {
...
// ── NL → task (web UI) ────────────────────────────────────────
export function nlToTaskPrompt(input, projectName, members, today) {
...
export function stakeholderEmailPrompt(project, completedThisWeek, inProgress, blockers, overallHealthScore) {
...
// ── Project Q&A ───────────────────────────────────────────────
export function projectQaPrompt(question, project, tasks, members, milestones, recentUpdates) {
